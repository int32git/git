 ...
 */
exports.createServerSupabaseClient = (0, react_1.cache)(function () {
    var cookieStore = (0, headers_1.cookies)();
    return (0, auth_helpers_nextjs_1.createServerComponentClient)({ cookies: function () { return cookieStore; } });
});
/**
...
function getSession() {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, session, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    supabase = (0, exports.createServerSupabaseClient)();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
